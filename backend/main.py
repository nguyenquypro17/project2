...
# Load YOLO model
model_path = "/Users/ducquynguyen/Desktop/best.pt" # Đường dẫn model đã fine-tune
...
async def detect(file: UploadFile = File(...)):
    try:
        ...
        plate_text = ""
        confidence = 0.0
        box_coords = []  # Thêm biến khởi tạo tọa độ
        ...
        if results and len(results) > 0:
            ...
            if len(result.boxes) > 0:
                ...
                box_coords = [x1, y1, x2, y2]  # Gán tọa độ
        ...
        # Bổ sung key "box" để frontend vẽ khung
        return {
